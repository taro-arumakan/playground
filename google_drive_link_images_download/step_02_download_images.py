...
category = 'apparel_20240709'

# Load the CSV file generated by the Google Apps Script
csv_file = '/Users/taro/Downloads/downloadUrls_apparel_new_20240709.csv'
output_folder = f'images_gbh_{category}'
...
def get_output_image_name(product, image_name):
    ...
    return f'{category}_{product}_{product_counters[product]:02}.{ext}'
